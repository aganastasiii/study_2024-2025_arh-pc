...
Я предоставила определенные права файлу readme.txt в соответствие с вариантом 15 (рис. [-@fig:007], рис. [-@fig:008]).

![Разрешения для файла readme.txt](image/7.png){ #fig:007 width=70% }

![Разрешения для файла readme.txt](image/8.png){ #fig:008 width=70% }

# Задание для самостоятельной работы

Я создала файл lab10-2.asm и написала программу, которая запрашивает имя и выводит его в созданном файле (рис. [-@fig:009]). Файл создает сама программа.

![Текст программы](image/9.png){ #fig:009 width=70% }

Создала и запустила исполняемый файл (рис. [-@fig:010]).
